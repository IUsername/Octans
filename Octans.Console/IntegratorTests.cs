...
namespace Octans.ConsoleApp
{
    public static class IntegratorTests
    {
        public static void TestRender(int spp, int height)
        {
            ...
            var filter = new MitchellFilter(new Vector2(2f, 2f), 0.335f, 0.33f);
            ...
            var integrator = new WhittedIntegrator(3, camera, new HaltonSampler(spp, film.GetSampleBounds()),
                                                   film.CroppedBounds);
        ...
        private static IScene Build()
        {
            ...
            var s1g = new GeometricPrimitive(s1, red, null);
            ...
            var s4g = new GeometricPrimitive(s4, white, null);
            ...
            var lt = Transform.Translate(0, 800, -800);
