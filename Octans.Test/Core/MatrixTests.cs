...
namespace Octans.Test
{
    public class MatrixTests
    {
        ...
        public void MultiplyMatrices()
        {
            ...
            (a * b).Should()
                   .BeEquivalentTo(new Matrix(20, 22, 50, 48, 44, 54, 114, 108, 40, 58, 110, 102, 16, 26, 46, 42));
        }
        ...
        {
            var a = new Matrix(1, 2, 3, 4, 1, 2, 4, 8, 2, 4, 8, 16, 4, 8, 16, 32);
        ...
        {
            var m = new Matrix(0, 9, 3, 0, 9, 8, 0, 8, 1, 8, 5, 3, 0, 0, 5, 8);
            m.Transpose().Should().BeEquivalentTo(new Matrix(0, 9, 1, 0, 9, 8, 8, 0, 3, 0, 5, 5, 0, 8, 3, 8));
        }
        ...
        {
            var m = new Matrix(-2, -8, 3, 5, -3, 1, 7, 3, 1, 2, -9, 6, -6, 7, 7, -9);
        ...
        {
            var m = new Matrix(6, 4, 4, 4, 5, 5, 7, 9, 4, -9, 3, -7, 9, 1, 7, -6);
        ...
        {
            var m = new Matrix(-4, 2, -2, -3, 9, 6, 2, 6, 0, -5, 1, -5, 0, 0, 0, 0);
        ...
        public void MatrixInverse()
        {
            ...
            invA.Should()
                .BeEquivalentTo(
                    new Matrix(-0.15385f, -0.15385f, -0.28205f, -0.53846f,
                                  -0.07692f, 0.12308f, 0.02564f, 0.03077f,
                                  0.35897f, 0.35897f, 0.43590f, 0.92308f,
                                  -0.69231f, -0.69231f, -0.76923f, -1.92308f));

            var b = new Matrix(9, 3, 0, 9, -5, -2, -6, -3, -4, 9, 6, 4, -7, 6, 6, 2);
            var invB = b.Inverse();
            invB.Should()
                .BeEquivalentTo(
                    new Matrix(-0.04074f, -0.07778f, 0.14444f, -0.22222f,
